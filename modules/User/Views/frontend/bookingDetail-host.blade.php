...
$endTime=substr($enddate1[1],0,5);
    $payments = \App\Helpers\CodeHelper::getBookingTransactions($booking->id);
    ?>
                        ...
                        <div class="card mt-3 card-default full-height-n card-bordered p-4 card-radious payment-card">
                          ...
                          <div class="payment-info">
                                ...
                                <div class="amount">
                                    ...
                                    class="status-btn {{ ($payment['status']=="completed")?"confirmed":'pending' }} success">{{ strtoupper(($payment['status']=="completed")?"confirmed":'pending') }}</h5>
                                </div>
                                <div class="amount"> 
                                    <h6>Amount</h6>
							...
							<div class="payment-actions">
                                <a target="_blank" href="{{ route('user.booking.invoice', $booking->code) }}?download=true" class="btn btn-primary reverse">Download Invoice</a>
                                <?php
                                if($booking->is_credit_issued === 1 || $booking->is_credit_issued === "1"){
                                    ?>
                                    <a style="opacity: 0.7;cursor:default;" href="javascript:;" class="btn btn-primary reverse">Promo Credit Issued</a>
                                    <?php
                                }else{
                                    ?>
                                    <a href="{{ route('user.booking.issueCredit', $booking->code) }}" class="btn btn-primary reverse">Issue Promo Credit</a>
                                    <?php
                                }
                                ?>
                            </div>
            ...
            checkTimeAvailability(false);
	            ...
	            <div class="col-lg-6 col-sm-12 tab-view">
                    ...
                    <div class="space-host-actions">
                                ...
                                <a class="btn btn-primary" href="{{ route('user.booking.invoice', $booking->code) }}?download=true" target="_blank"><span
                                        class="material-icons">email</span>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane slide-left" id="slide2">
                                <div class="row column-seperation">
                                    <div class="col-lg-12">
                                        <h3>House Rules</h3>
                                        <div class="disable-formatting disable-formatting-rules">{!! $booking->service->house_rules != null ? $booking->service->house_rules : $spaceSettings['space_default_house_rules'] !!}</div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="g-rules">
                                    <div class="description">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                <div class="value">{{ $booking->total_guests }} {{$booking->total_guests > 1 ? "Guests": "Guest"}}</div>
                                            </div>
                                        </div>
                                        {{-- @endif --}}
                                        @if ($row->bathroom != '')
                                        ...
                                        @foreach ($attributes as $attribute)
                                            @if (empty($attribute['parent']['hide_in_single']))
                                                ...
                                                <li
                                                    ...
                                                    <span style="font-size: 13.5px; font-weight:400;font-family:Roboto" class="aminidis">{{ $attribute->name }}</span>
                                                </li>
                                            @endif
                                        @endforeach
                                    @endif

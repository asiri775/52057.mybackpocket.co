                ...
                <tr class="twoinline">
                        ...
                        <div class="invoice-bill-options">
                            <table class="inv-table">
                                ...
                                <tr>
                                    <td>
                                        <span
                                            style="font-weight: 600;">{{ $booking->first_name . ' ' . $booking->last_name }}
                    ...
                    <th width="50%" class="rightdata">
                        <table class="inv-table">
                            ...
                            <tr>
                                <td>
                                    <span style="font-weight: 600;">{!! clean($translation->title) !!}</span> <br>
                                    ...
                                    <br>
                                    <span
                                        style="font-weight: 600;">Arrival:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                    {{ display_date($booking->start_date) }}<br>
                                    <span style="font-weight: 600;">Departure:&nbsp;&nbsp;</span>
                        ...
                        <div class="invoice-make-it-count">
                            ...
                            <div class="content">
                                ...
                                <p>Help Us Make A Difference! Your small micro donation will go
                                    ...
                                    your donation.</p>
                                <p><a style="color: #000;font-weight:600;" href="http://www.janeen.ca" target="_blank">Click

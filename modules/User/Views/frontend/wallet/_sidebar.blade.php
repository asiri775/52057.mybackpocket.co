...
if ($signUpReferral != null) {
    $referral_details = ReferralLink::where('user_id', $row->id)
...
<div class="card card-default card-bordered p-2 card-radious">
    ...
    <div class="card-body">
        ...
        @if ($row->promo_credits > 0)
            <a href="{{ route('user.wallet.redeemCredits') }}" class="btn btn-primary">Use Promo Credits Now</a>
        @endif
        @if ($referral_details)
            <hr />
            <h6>Earn Credits</h6>
            ...
            <div class="referral-box">
                ...
                <div class="social-buttons">  
                    <ul>
                        ...
                        <li>
                            <a href="mailto:?subject=MyOffice+Discount+Code&body={{ $text }}" target="_blank" title="Email">

<div class="panel">
    ...
    <div class="panel-body">
        ...
        <!-- <div class="form-group">
            <label class="control-label">{{ __('Description') }}</label><button class="btn btn-warning ml-2">Generate</button>
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="right">
                <a href="{{ route('space.generator') }}" class="btn btn-warning" style="height: 2rem; margin-right: 15px;">Try our description generator</a>
                </div>
            </div>
            <textarea name="content" class="d-none has-ckeditor form-control mt-2" cols="30" rows="10">{{ old('content', $translation->content) }}</textarea>
        </div>
    ...
    <div class="panel">
        ...
        <div class="panel-body">
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                var generatedDescription = localStorage.getItem('generatedDescription');
                if (textarea && generatedDescription) {

                ...
                <div class="panel col-12 m-0 p-0">
                    <form action="{{ route('space.generator') }}" method="post" class="bravo-form-item">
                        ...
                        <div class="row p-2">
                            ...
                            <a href="{{ route('space.generator') }}" id="backToDashboardBtn">
                                <button class="btn-secondary btn-sm btn btn-icon btn_search float-right mt-2">{{ __('Back to Dashboard') }}</button>
                            </a>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#backToDashboardBtn').on('click', function(event) {
                ...
                window.location.href = '{{ route("space.generator") }}';
            });
        });
    </script>
@endsection

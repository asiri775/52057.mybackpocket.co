...
<div class="promotion promotion-pro-box mt-5">
    ...
    <div class="pro-card promotion-pro-head">
        ...
        @if (\App\Helpers\CodeHelper::checkIfNumValNotNull($spacePriceData['discountRate']))
            <div class="right">
                <span class="arrow right" style="font-family: 'Montserrat">{{ round($spacePriceData['discountRate'], 0) }}%
                    OFF!</span>
            </div>
        @endif
    </div>
            ...
            <div class="form-section-group form-group">
                <div class="form-section-group inputs-book-form-guests form-group" style="padding-bottom: 0;">
                    ...
                    <div class="form-group flex">
                        ...
                        <input type="text" placeholder="@if ($row->max_guests <= 1) {{ __('Maximum Capacity: :count Guest', ['count' => $row->max_guests]) }} @else {{ __('Maximum Capacity: :count Guests', ['count' => $row->max_guests]) }} @endif" id="adultsFieldItem" class="form-control" required
                    name="adults">
                    </div>
                </div>

@php
    ...
    if ($meta = $booking->getMeta('adults')) {
        ...
        $adults_text =
            ...
            <td style="padding: 10px;text-align: right;font-weight: 500;border-bottom: 1px solid #EAEEF3;"><strong>' .
            $adults .
            '</strong></td>
        </tr>';
    }
    ...
    if (!empty($extra_price)) {
        foreach ($extra_price as $type) {
            $extra .=
                '<tr>
        <td style="padding: 10px; font-weight: 500;border-bottom: 1px solid #EAEEF3;">' .
                $type['name'] .
                ':</td>
        <td style="padding-right: 0px!important;padding: 10px;text-align: right;font-weight: 500;border-bottom: 1px solid #EAEEF3;"><strong>' .
                $type['total'] .
                '</strong></td>
        </tr>';
        }
    ...
    if (!empty($list_all_fee)) {
        foreach ($list_all_fee as $item) {
            ...
            <td style="padding: 10px; font-weight: 500;border-bottom: 1px solid #EAEEF3;">' .
                $item['name'] .
                '
                <i class="icofont-info-circle" data-toggle="tooltip" data-placement="top" title="' .
                $item['desc'] .
                '"></i>';
